  ...
  return (
    <div className='w-full h-full flex flex-col justify-center items-center bg-gray-300 text-white font-serif'>
      ...
      <p className='text-3xl text-lime-500'>Create an account</p>
        ...
        <input type="text" placeholder='  Enter your name' className='border-b-2 border-white h-10 w-[300px]' />
          <input type="text" placeholder='  Enter email address' className='border-b-2 border-white h-10 w-[300px]'/>
          <input type="text" placeholder='  Enter phone number' className='border-b-2 border-white h-10 w-[300px]'/>
        <input type="password" placeholder='  Enter password' className='border-b-2 border-white h-10 w-[300px]' />
        <input type="password" placeholder='  Confirm password' className='border-b-2 border-white h-10 w-[300px]' />
        </div>
